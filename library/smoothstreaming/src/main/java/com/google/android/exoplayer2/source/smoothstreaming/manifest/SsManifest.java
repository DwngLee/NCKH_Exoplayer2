...
public class SsManifest {
  ...
  public static class StreamElement {
    ...
    public Uri buildRequestUri(int track, int chunkIndex) {
      //khuatduc System.out.println("dfghjkl:::"+track);
      ...
      Log.e("track0000::",String.valueOf(track));
      Log.e("Ftrack0001::",bitrateString);
      String startTimeString = chunkStartTimes.get(chunkIndex).toString();
      //if(!bitrateString.equals("128000")) bitrateString="230000";
