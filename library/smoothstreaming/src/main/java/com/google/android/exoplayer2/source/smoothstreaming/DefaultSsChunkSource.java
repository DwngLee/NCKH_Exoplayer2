...
public class DefaultSsChunkSource implements SsChunkSource {
  ...
  public DefaultSsChunkSource(
    ...
    for (int i = 0; i < extractorWrappers.length; i++) {
      ...
      System.out.println("fghjkl:::"+manifestTrackIndex);
  ...
  public final void getNextChunk(MediaChunk previous, long playbackPositionUs, long loadPositionUs,
    ...
    //int trackSelectionIndex=6 khuatducnhanh12;
    //System.out.println("nhanh12:::"+trackSelectionIndex);
    ChunkExtractorWrapper extractorWrapper = extractorWrappers[trackSelectionIndex];

    int manifestTrackIndex = trackSelection.getIndexInTrackGroup(trackSelectionIndex);
    Uri uri = streamElement.buildRequestUri(manifestTrackIndex, chunkIndex);
    //nhanh1khuatduc
    //System.out.println("nhanh1::::"+uri);
